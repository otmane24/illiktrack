...
class  Image {
  ...
  factory Image.fromJson(Map<String, dynamic> parsedJson){
    return Image(
        imageName : parsedJson [ 'formatted_address' ]
    );
  }
}
class Localisation {
...
List<Localisation> analyseCars(String responseBody){
  ...
  return parsedJson<Localisation>((json) => Localisation.fromJson(json)).toList();
}

Future<List<Localisation>> fetchCars(Position place) async {
  String url = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${place.latitude},${place.longitude}&key=AIzaSyBR046smIiQUeRbBaErZWkgtdiMFmOlAlc" ;
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text((snapShot.hasData ? "lat : ${_currentPosition.latitude.toString()}  lon : ${_currentPosition.longitude.toString()}": "location" ),
                                            style: TextStyle(
                                              fontSize: 14,
                                            )),
                                        SizedBox(
